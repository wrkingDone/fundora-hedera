...
const NavBar = () => {
  ...
  return (
     <div class="backgroundMain">
      <div class="px-4 mx-auto py-5 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="relative flex items-center justify-between">
          <div class="flex items-center">
            ...
            <div class="lg:hidden z-40">
              ...
              {isMenuOpen && (
                <div class="absolute top-0 left-0 w0-full">
                        ...
                        {menuList.map((el, i) => (
                          <li key={i + 1}>
                            <a 
                              ...
                              aria-label="Our Products"
                              title="Our Product"
                              class="font-medium tracking-wide tet-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400"
                            >
                              {el}
                            </a>
                          </li>
